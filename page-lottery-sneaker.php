...
<title>スニーカー 抽選情報一覧｜抽選サーチ</title>
<meta property="og:title" content="スニーカー 抽選情報一覧｜抽選サーチ">
<meta property="og:description" content="スニーカーの抽選情報を店舗別に一覧表示。締切間近の抽選をリアルタイムでチェック。">
<meta property="og:url" content="https://tyusensearch.com/sneaker/">
...
<nav class="bottom-nav">
  ...
  <a class="nav-btn active" href="<?php echo home_url('/sneaker/'); ?>"><span class="nav-ico">🃏</span>ポケカ</a>
  <a class="nav-btn active" href="<?php echo home_url('/sneaker/'); ?>"><span class="nav-ico">👟</span>スニーカー</a>
...
function getCookieChecks() {
  var m = document.cookie.match(/(?:^|; )tcs_chk_sneaker=([^;]*)/);
...
function saveCookieChecks(obj) {
  ...
  document.cookie = 'tcs_chk_sneaker=' + encodeURIComponent(JSON.stringify(obj)) + '; expires=' + exp.toUTCString() + '; path=/';
}
