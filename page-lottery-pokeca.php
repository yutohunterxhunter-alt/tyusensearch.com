...
<title>ポケカ 抽選情報一覧｜抽選サーチ</title>
<meta property="og:title" content="ポケカ 抽選情報一覧｜抽選サーチ">
<meta property="og:description" content="ポケモンカードの抽選情報を店舗別に一覧表示。締切間近の抽選をリアルタイムでチェック。">
<meta property="og:url" content="https://tyusensearch.com/pokeca/">
<meta property="og:type" content="website">
<meta property="og:image" content="https://tyusensearch.com/ogp/ogp-pokeca.jpg">
...
<nav class="bottom-nav">
  ...
  <a class="nav-btn active" href="<?php echo home_url('/pokeca/'); ?>"><span class="nav-ico">🃏</span>ポケカ</a>
  <a class="nav-btn" href="<?php echo home_url('/sneaker/'); ?>"><span class="nav-ico">👟</span>スニーカー</a>
  <a class="nav-btn" href="<?php echo home_url('/other/'); ?>"><span class="nav-ico">🎮</span>その他</a>
...
function getCookieChecks() {
  var m = document.cookie.match(/(?:^|; )tcs_chk_pokeca=([^;]*)/);
...
function saveCookieChecks(obj) {
  ...
  document.cookie = 'tcs_chk_pokeca=' + encodeURIComponent(JSON.stringify(obj)) + '; expires=' + exp.toUTCString() + '; path=/';
}
...
(function() {
  ...
  if (s) {
    activeSeries = s;
    // ドロップダウンボタンのラベルも更新（renderTable内でも更新されるが念のため）
    var btn = document.getElementById('th-series-btn');
