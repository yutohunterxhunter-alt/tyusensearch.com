...
<title>その他 抽選中の商品一覧｜抽選サーチ</title>
<meta property="og:title" content="その他 抽選中の商品一覧｜抽選サーチ">
<meta property="og:description" content="その他の抽選中商品を一覧表示。商品を選んで店舗別の抽選情報をチェック。">
<meta property="og:url" content="https://tyusensearch.com/other-series/">
...
<nav class="bottom-nav">
  ...
  <a href="<?php echo home_url('/other-series/'); ?>" class="nav-btn"><span class="nav-ico">🃏</span>ポケカ</a>
  <a href="<?php echo home_url('/sneaker-series/'); ?>" class="nav-btn"><span class="nav-ico">👟</span>スニーカー</a>
  <a href="<?php echo home_url('/other-series/'); ?>" class="nav-btn active"><span class="nav-ico">🎮</span>その他</a>
</nav>

<script>
var WP_API = '<?php echo home_url('/wp-json/wp/v2/lottery'); ?>';
var LIST_URL = '<?php echo home_url('/other/'); ?>';
var CAT = 'other';
var allData = [];
