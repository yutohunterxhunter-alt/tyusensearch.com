...
<title>ポケカ 抽選中の商品一覧｜抽選サーチ</title>
<meta property="og:title" content="ポケカ 抽選中の商品一覧｜抽選サーチ">
<meta property="og:description" content="ポケモンカードの抽選中商品を一覧表示。商品を選んで店舗別の抽選情報をチェック。">
<meta property="og:url" content="https://tyusensearch.com/pokeca-series/">
...
<nav class="bottom-nav">
  ...
  <a href="<?php echo home_url('/pokeca-series/'); ?>" class="nav-btn active"><span class="nav-ico">🃏</span>ポケカ</a>
...
var LIST_URL = '<?php echo home_url('/pokeca/'); ?>';
var CAT = 'pokeca';
var allData = [];
